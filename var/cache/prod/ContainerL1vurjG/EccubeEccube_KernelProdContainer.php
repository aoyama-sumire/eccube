...
class EccubeEccube_KernelProdContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $j = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($f, [0 => (\dirname(__DIR__, 4).'/app/Plugin/EntityExtension/Entity')]);
        $j->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $k = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($f, [0 => (\dirname(__DIR__, 4).'/app/Plugin/EntityForm/Entity')]);
        $k->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $l = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($f, [0 => (\dirname(__DIR__, 4).'/app/Plugin/MailMagazine4/Entity')]);
        $l->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $m = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($f, [0 => (\dirname(__DIR__, 4).'/app/Plugin/MigrationSample/Entity')]);
        $m->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $n = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($f, [0 => (\dirname(__DIR__, 4).'/app/Plugin/ProductReview4/Entity')]);
        $n->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $o = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($f, [0 => (\dirname(__DIR__, 4).'/app/Plugin/Recommend4/Entity')]);
        $o->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $p = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($f, [0 => (\dirname(__DIR__, 4).'/app/Plugin/RelatedProduct4/Entity')]);
        $p->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $q = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($f, [0 => (\dirname(__DIR__, 4).'/app/Plugin/Securitychecker4/Entity')]);
        $q->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $r = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($f, [0 => (\dirname(__DIR__, 4).'/app/Plugin/SiteKit/Entity')]);
        ...
        $e->addDriver($j, 'Plugin\\EntityExtension\\Entity');
        $e->addDriver($k, 'Plugin\\EntityForm\\Entity');
        $e->addDriver($l, 'Plugin\\MailMagazine4\\Entity');
        $e->addDriver($m, 'Plugin\\MigrationSample\\Entity');
        $e->addDriver($n, 'Plugin\\ProductReview4\\Entity');
        $e->addDriver($o, 'Plugin\\Recommend4\\Entity');
        $e->addDriver($p, 'Plugin\\RelatedProduct4\\Entity');
        $e->addDriver($q, 'Plugin\\Securitychecker4\\Entity');
        $e->addDriver($r, 'Plugin\\SiteKit\\Entity');
    ...
    {
        $a = new \Monolog\Handler\NullHandler(100, true);
        $a->pushProcessor(($this->privates['monolog.processor.psr_log_message'] ?? ($this->privates['monolog.processor.psr_log_message'] = new \Monolog\Processor\PsrLogMessageProcessor())));

        return $this->privates['monolog.handler.e_user_deprecated_filter'] = new \Monolog\Handler\FilterHandler($a, [0 => 200], 600, false);
    }
    ...
    protected function getSecurity_FirewallService()
    {
        return $this->privates['security.firewall'] = new \Symfony\Bundle\SecurityBundle\EventListener\FirewallListener(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            yield 'security.firewall.map.context.admin' => ($this->privates['.security.request_matcher.9e1znPj'] ?? ($this->privates['.security.request_matcher.9e1znPj'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/'.$this->getEnv('string:ECCUBE_ADMIN_ROUTE').'/')));
